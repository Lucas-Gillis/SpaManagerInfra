...
*Detalhes:*
- Documentacao sobre os comandos usados para criacao do container do POSTGRES, incluindo caminho do docker volume que garante a persistencia dos dados
- Informacoes sobre as configuracoes adotadas dentro do POSTGRES
