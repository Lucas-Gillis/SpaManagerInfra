...
Endereço Comercial
Como Conheceu (cadastro na aba de administração)
Telefone
Email
Histórico de Compras (puxar as compras por período)
Saldo (caso cliente faça pagamento de pacote adiantado vai descontando do saldo cada agendamento)
Campo para cadastro livre de observações.
...
Se for administrativo ter um box que ele seja elegível para ganhar comissão onde posso cadastrar a % na aba de vendas ou no agendamento avulso
Email
Acesso a própria agenda para verificação

4.      Agenda

Seleciona o Profissional > Seleciona o Serviço > Avulso (cadastra valor) > Seleciona Cliente > Seleciona Endereço Residencial / comercial do cliente ou da empresa para atendimento.
Agendamento Recorrente em vez de avulso seria toda terça as 20:00 por exemplo.
...
Como Conheceu
Onde teve mais atendimentos na empresa ou à domicilio

7.      Aba para Cliente logar com o email e verificar agenda e mudar seus dados
